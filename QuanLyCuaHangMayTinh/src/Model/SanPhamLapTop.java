 ...
 */
public class SanPhamLapTop extends SanPhamMayTinh {

    private double kichThuocMan;
    private String dungLuongPin;

    public SanPhamLapTop(double kichThuocMan, String dungLuongPin, String maMay, String tenMay, int soLuong, double gia, String tenCpu, String ram, String xuatXu, String cardManHinh, String Rom, int trangThai) {
    ...
    public boolean equals(Object obj) {
        ...
        final SanPhamLapTop other = (SanPhamLapTop) obj;

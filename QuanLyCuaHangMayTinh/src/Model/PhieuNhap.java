 ...
 */
public class PhieuNhap extends PhieuTao{
    ...
    public PhieuNhap(String nhaCungCap, String maPhieu, Timestamp thoiGianTao, String nguoiTao, ArrayList<ChiTietPhieuNhapXuat> CTPhieu, double tongTien) {
        super(maPhieu, thoiGianTao, nguoiTao, CTPhieu, tongTien);
        this.nhaCungCap = nhaCungCap;
    }


    private PhieuNhap(String maPhieu, Timestamp thoiGianTao, String nguoiTao, ArrayList<ChiTietPhieuNhapXuat> CTPhieu, double tongTien) {

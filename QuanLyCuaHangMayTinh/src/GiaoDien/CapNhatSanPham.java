...
public class CapNhatSanPham extends javax.swing.JDialog {
    ...
    public CapNhatSanPham(javax.swing.JInternalFrame parent, javax.swing.JFrame owner, boolean modal) {
        super(owner, modal);
        this.owner = (SanPhamForm) parent;
        initComponents();
        setLocationRelativeTo(null);
        if (this.owner.checklap()) {
            SanPhamLapTop a = this.owner.getDetailLapTop();
            ...
            SanPhamPC a = this.owner.getDetailPC();
            txtMaSanPham.setText(a.getMaMay());
            txtTenSanPham.setText(a.getTenMay());
    ...
    private CapNhatSanPham(JFrame jFrame, boolean b) {
    ...
    private void btnAddProductActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAddProductActionPerformed
        ...
        if (cbxloaisp.getSelectedItem().equals("Laptop")) {
            ...
            if (maMay.equals("") || tenMay.equals("") || cpu.equals("") || ram.equals("") || rom.equals("") || gpu.equals("") || xuatxu.equals("") || dungluongpin.equals("")) {
                ...
                SanPhamLapTop lp = new SanPhamLapTop(kichthuocman, dungluongpin, maMay, tenMay, soluong, dongia, cpu, ram, xuatxu, gpu, rom,1);
                try {
                    SanPhamLapTopDAO.getInstance().update(lp);
                    this.dispose();
        ...
        if (cbxloaisp.getSelectedItem().equals("PC - Lắp ráp")) {
            ...
            if (maMay.equals("") || tenMay.equals("") || cpu.equals("") || ram.equals("") || rom.equals("") || gpu.equals("") || xuatxu.equals("") || mainboard.equals("")) {
                ...
                SanPhamPC pc = new SanPhamPC(mainboard, congsuatnguon, maMay, tenMay, soluong, dongia, cpu, ram, xuatxu, gpu, rom,1);
                System.out.println(pc);
                SanPhamPCDAO.getInstance().update(pc);
                this.dispose();
                JOptionPane.showMessageDialog(this, "Sửa sản phẩm thành công !");
                owner.loadDataToTable();
            }

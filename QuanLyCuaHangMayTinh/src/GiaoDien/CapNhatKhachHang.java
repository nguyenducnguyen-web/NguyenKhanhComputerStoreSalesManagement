...
public class CapNhatKhachHang extends javax.swing.JDialog {
    ...
    public CapNhatKhachHang(javax.swing.JInternalFrame parent, javax.swing.JFrame owner, boolean modal) {
        super(owner, modal);
    ...
    private CapNhatKhachHang(JFrame jFrame, boolean b) {
        throw new UnsupportedOperationException("Not supported yet."); 
    }
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try {
            ...
            kh.setSoDienThoai(txtPhone.getText());
    ...
    public static void main(String args[]) throws UnsupportedLookAndFeelException {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                CapNhatKhachHang dialog = new CapNhatKhachHang(new KhachHangForm(), new javax.swing.JFrame(), true);

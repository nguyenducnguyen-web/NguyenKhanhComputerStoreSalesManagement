...
public class CTThongKe extends javax.swing.JDialog {
    ...
    public CTThongKe(javax.swing.JInternalFrame parent, javax.swing.JFrame owner, boolean modal) {
        ...
        PhieuTao pn = this.parent.findPhieu();
    ...
    public void loadDataToTableProduct() {
        try {
            ...
            if (check.contains("PX")) {
                ArrayList<ChiTietPhieuNhapXuat> CTPhieu = ChiTietPhieuXuatDAO.getInstance().selectAll(check);
                ...
                ArrayList<ChiTietPhieuNhapXuat> CTPhieu = ChiTietPhieuNhapDAO.getInstance().selectAll(check);
                for (int i = 0; i < CTPhieu.size(); i++) {
                    tblCTPhieumd.addRow(new Object[]{
                        i + 1,
                        CTPhieu.get(i).getMaMay(),
    ...
    public ArrayList<PhieuTao> getPhieuAll() {
        ...
        for (PhieuNhap phieuNhap : conten1) {
            ...
            PhieuTao ac = new PhieuTao(maPhieu, thoiGianTao, nguoiTao, tongTien);
            result.add(ac);
        }
    ...
    private void initComponents() {
        ...
        labelMaPhieu.setFont(new java.awt.Font("SF Pro Display", 1, 16)); // NOI18N
        labelMaPhieu.setText("maphieu");

        labelNguoiTao.setFont(new java.awt.Font("SF Pro Display", 1, 16)); // NOI18N
        labelNguoiTao.setText("ngtao");

        labelThoiGianTao.setFont(new java.awt.Font("SF Pro Display", 1, 16)); // NOI18N
        ...
        btnExportPDF.setBackground(new java.awt.Color(255, 51, 51));

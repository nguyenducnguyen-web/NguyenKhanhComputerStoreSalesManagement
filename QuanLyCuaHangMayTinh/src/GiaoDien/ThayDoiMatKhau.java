...
public class ThayDoiMatKhau extends javax.swing.JDialog {
    ...
    public ThayDoiMatKhau(javax.swing.JFrame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        setLocationRelativeTo(null);
    }

    public ThayDoiMatKhau(javax.swing.JFrame parent, boolean modal, TaiKhoan t) {
        super(parent, modal);
        initComponents();
        setLocationRelativeTo(null);
        this.accCur = t;
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if (nameAccount.equals("") || emailAccount.equals("") || passwordAccount.equals("")) {
            ...
            if (isValid(emailAccount)) {
                if (MaHoaMatKhau.checkpw(passwordAccount, accCur.getPassword())) {
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        if (check == true) {
            if (MaHoaMatKhau.checkpw(curPass, accCur.getPassword())) {
//                BCrypt.hashpw(txtpassword.getText(), BCrypt.gensalt(12))
                if (newPass.length() < 6) {
                    ...
                    if (newPass.equals(newPassConf)) {
                        String pass = MaHoaMatKhau.hashpw(passAft.getText(), MaHoaMatKhau.gensalt(12));

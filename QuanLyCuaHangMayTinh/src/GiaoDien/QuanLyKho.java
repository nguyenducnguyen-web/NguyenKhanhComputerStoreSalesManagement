...
public class QuanLyKho extends javax.swing.JFrame {
    ...
    public QuanLyKho() throws UnsupportedLookAndFeelException {
        UIManager.setLookAndFeel(new FlatLightLaf());
        UIManager.put("Table.showVerticalLines", true);
        UIManager.put("Table.showHorizontalLines", true);
        initComponents();
        setLocationRelativeTo(null);
        SanPhamForm pf = new SanPhamForm();
        ...
        setFormTitle("Giao diện quản lý kho - Chương trình quản lý bán hàng");
    }
    ...
    private void initComponents() {
        ...
        NavbarMenu.add(NameUser, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 70, 180, -1));

...
public class TonKhoForm extends javax.swing.JInternalFrame {
    ...
    public void loadDataToTable() {
        try {
            ...
            ArrayList<SanPhamMayTinh> armt = mtdao.selectAllE();
    ...
    private void initComponents() {
        ...
        jComboBoxLuaChon.setBackground(new java.awt.Color(0, 255, 51));
    ...
    public void xoaMayTinhSelect() {
        ...
        if (luaChon == JOptionPane.YES_OPTION) {
            SanPhamMayTinhDAO.getInstance().delete(getMayTinhSelect());
    ...
    public SanPhamMayTinh getMayTinhSelect() {
        int i_row = tblSanPham.getSelectedRow();
        SanPhamMayTinh acc = SanPhamMayTinhDAO.getInstance().selectAll().get(i_row);
        return acc;
    }

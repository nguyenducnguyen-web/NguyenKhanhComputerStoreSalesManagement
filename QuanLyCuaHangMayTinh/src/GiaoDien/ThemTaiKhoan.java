...
public class ThemTaiKhoan extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        vaitro.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Quản lý kho", "Nhân viên nhập", "Nhân viên xuất", "Nhân viên xử lý hoá đơn" }));
    ...
    String password = MaHoaMatKhau.hashpw(txtpassword.getText(), MaHoaMatKhau.gensalt(12));
    ...
    if (fullName.equals("") || user.equals("") || password.equals("") || role.equals("") || email.equals("")) {
        ...
        if (TaiKhoanDAO.getInstance().selectById(user) == null) { 
            if (isValid(email)) {
                TaiKhoan acc = new TaiKhoan(fullName, user, password, role, 1, email);

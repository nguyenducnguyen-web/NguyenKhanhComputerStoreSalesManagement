...
public class ThemSanPham extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        btnAddProduct.setBackground(new java.awt.Color(255, 51, 51));
    ...
    private void btnAddProductActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAddProductActionPerformed
        ...
        if (cbxloaisp.getSelectedItem().equals("Laptop")) {
            ...
            if (maMay.equals("") && tenMay.equals("") && cpu.equals("") && ram.equals("") && rom.equals("") && gpu.equals("") && xuatxu.equals("") && dungluongpin.equals("")) {
                ...
                SanPhamLapTop lp = new SanPhamLapTop(kichthuocman, dungluongpin, maMay, tenMay, 0, dongia, cpu, ram, xuatxu, gpu, rom,trangThai);
                try {
                    SanPhamLapTopDAO.getInstance().insert(lp);
                    this.dispose();
        ...
        if (cbxloaisp.getSelectedItem().equals("PC")) {
            ...
            if (maMay.equals("") && tenMay.equals("") && cpu.equals("") && ram.equals("") && rom.equals("") && gpu.equals("") && xuatxu.equals("") && mainboard.equals("")) {
                ...
                SanPhamPC pc = new SanPhamPC(mainboard, congsuatnguon, maMay, tenMay, 0, dongia, cpu, ram, xuatxu, gpu, rom,trangThai);
                SanPhamPCDAO.getInstance().insert(pc);
                this.dispose();
                JOptionPane.showMessageDialog(this, "Thêm sản phẩm thành công !");
                owner.loadDataToTable();
            }
    ...
    public String createIdPC() {
        ArrayList<SanPhamMayTinh> mtAll = SanPhamMayTinhDAO.getInstance().selectAll();
        ArrayList<SanPhamMayTinh> pcAll = new ArrayList<SanPhamMayTinh>();
        for (SanPhamMayTinh mayTinh : mtAll) {
        ...
        while(check.length()!=0){
            i++;
            for (SanPhamMayTinh mayTinh : pcAll) {
    ...
    public String createIdLT() {
        ArrayList<SanPhamMayTinh> mtAll = SanPhamMayTinhDAO.getInstance().selectAll();
        ArrayList<SanPhamMayTinh> lpAll = new ArrayList<SanPhamMayTinh>();
        for (SanPhamMayTinh mayTinh : mtAll) {
        ...
        while(check.length()!=0){
            i++;
            for (SanPhamMayTinh mayTinh : lpAll) {

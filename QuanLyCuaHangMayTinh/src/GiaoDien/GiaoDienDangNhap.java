...
public class GiaoDienDangNhap extends javax.swing.JFrame {
    ...
    public GiaoDienDangNhap() {
        ...
        panEnter = new Color(255, 102, 102);
        JPaneLogin.setBackground(panDefualt);
        
        
        setFormTitle("Đăng nhập hệ thống - Chương trình quản lý bán hàng");
    }
    ...
    private void initComponents() {
        ...
        jPanel1.add(jLabel4, new org.netbeans.lib.awtextra.AbsoluteConstraints(300, 170, 160, 40));

        jLabel5.setBorder(new javax.swing.border.LineBorder(new java.awt.Color(255, 255, 255), 1, true));
        jPanel1.add(jLabel5, new org.netbeans.lib.awtextra.AbsoluteConstraints(300, 330, 400, -1));

        jLabel6.setBorder(new javax.swing.border.LineBorder(new java.awt.Color(255, 255, 255), 1, true));
        jPanel1.add(jLabel6, new org.netbeans.lib.awtextra.AbsoluteConstraints(300, 240, 400, -1));

        loginUser.setFont(new java.awt.Font("SF Pro Display", 3, 18)); // NOI18N
        loginUser.setForeground(new java.awt.Color(255, 51, 51));
        ...
        jPanel1.add(loginUser, new org.netbeans.lib.awtextra.AbsoluteConstraints(300, 210, 400, 30));

        passwordUser.setFont(new java.awt.Font("Tahoma", 1, 18)); // NOI18N
        passwordUser.setForeground(new java.awt.Color(255, 51, 51));
        ...
        jPanel1.add(passwordUser, new org.netbeans.lib.awtextra.AbsoluteConstraints(300, 300, 400, 30));
        ...
        jPanel1.add(JPaneLogin, new org.netbeans.lib.awtextra.AbsoluteConstraints(390, 360, 190, 40));

        jLabel8.setFont(new java.awt.Font("SF Pro Display", 1, 18)); // NOI18N
        jLabel8.setForeground(new java.awt.Color(255, 255, 255));
        jLabel8.setText("Nhập mật khẩu");
        jPanel1.add(jLabel8, new org.netbeans.lib.awtextra.AbsoluteConstraints(300, 260, 170, 40));
        ...
        jPanel1.add(jLabel7, new org.netbeans.lib.awtextra.AbsoluteConstraints(590, 510, -1, -1));

        jLabel1.setFont(new java.awt.Font("Cantarell", 1, 65)); // NOI18N
        jLabel1.setForeground(new java.awt.Color(255, 255, 255));
        jLabel1.setText("Đăng nhập");
        jPanel1.add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(330, 60, 370, 70));
    ...
    private void jLabel7MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel7MouseClicked
        // TODO add your handling code here:
        KhoiPhucMatKhau rcv = new KhoiPhucMatKhau(this, rootPaneCheckingEnabled);
        rcv.setVisible(true);
        ...
        if (usercheck.equals("") || passwordcheck.equals("")) {
            ...
            try {                
                ...
                if (acc == null) {
                    ...
                    if (MaHoaMatKhau.checkpw(passwordcheck, acc.getPassword())) {
                        if (acc.getStatus() == 1) {
                            try {
...
//                                    ad.setCurrentAcc(acc);
                                    ...
                                    ql.setVisible(true);
                                    ql.setName(acc.getFullName());
                                } else if (role.equals("Nhân viên xử lý hoá đơn")) {
                                    NhanVienHoaDon ql = new NhanVienHoaDon(acc);
                                    ql.setVisible(true);
                                    ql.setName(acc.getFullName());
                                }

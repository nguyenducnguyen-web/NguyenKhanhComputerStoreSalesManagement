...
public class ThongKeForm extends javax.swing.JInternalFrame {
    ...
    public ThongKeForm() {
        ...
        txtQuantityProduct.setText(Integer.toString(SanPhamMayTinhDAO.getInstance().getSl()));
        ...
        changeTextFind();
        //
        loadDataToTableAcc(TaiKhoanDAO.getInstance().selectAll());
        ...
        //
        loadDataToTableThongKeProduct(ThongKeBaoCaoDAO.getInstance().getThongKe());
    }
    ...
    private void loadDataToTableSearch(ArrayList<PhieuTao> result) {
        try {
            tblModel.setRowCount(0);
    ...
    public ArrayList<PhieuTao> searchTatCa(String text) {
        ArrayList<PhieuTao> result = new ArrayList<>();
        ArrayList<PhieuTao> armt = PhieuNhapDAO.getInstance().selectAllP();
        for (var phieu : armt) {
    ...
    public ArrayList<PhieuTao> searchPhieuNhap(String text) {
        ArrayList<PhieuTao> result = new ArrayList<>();
    ...
    public ArrayList<PhieuTao> searchPhieuXuat(String text) {
        ArrayList<PhieuTao> result = new ArrayList<>();
    ...
    private void initComponents() {
        ...
        btnResetThongKePr.setBackground(new java.awt.Color(0, 255, 255));
        ...
        btnDetail.setBackground(new java.awt.Color(0, 255, 255));
        btnDetail.setText("Xem chi tiết");
        btnDetail.setCursor(new java.awt.Cursor(java.awt.Cursor.HAND_CURSOR));
        btnDetail.setFocusable(false);
        btnDetail.setHorizontalTextPosition(javax.swing.SwingConstants.CENTER);
        btnDetail.setMargin(new java.awt.Insets(12, 80, 12, 80));
        ...
        jComboBoxLuaChon.setBackground(new java.awt.Color(51, 255, 0));
        ...
        jComboBoxLuaChon1.setBackground(new java.awt.Color(0, 255, 255));
    ...
    private void jTextFieldSearch1KeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_jTextFieldSearch1KeyReleased
        ...
        switch (luachon) {
            case "Tất cả":
                result = TimKiemTaiKhoan.getInstance().searchTatCaAcc(searchContent);
                break;
            case "Tên tài khoản":
                result = TimKiemTaiKhoan.getInstance().searchFullName(searchContent);
                break;
            case "Tên đăng nhập":
                result = TimKiemTaiKhoan.getInstance().searchUserName(searchContent);
                break;
            case "Vai trò":
                result = TimKiemTaiKhoan.getInstance().searchRole(searchContent);
                break;
        }
    ...
    public PhieuTao getPhieuNhapSelect() {
        int i_row = tblPhieuNhap.getSelectedRow();
        PhieuTao pn = PhieuNhapDAO.getInstance().selectById(tblModel.getValueAt(i_row, 1).toString());
        return pn;
    }

    public PhieuTao findPhieu() {
        int i_row = tblPhieuNhap.getSelectedRow();
        String text = tblModel.getValueAt(i_row, 0).toString();
        ArrayList<PhieuTao> phieuAll = PhieuNhapDAO.getInstance().selectAllP();
        PhieuTao phieuk = null;
        for (PhieuTao phieu : phieuAll) {
    ...
    public void loadDataToTableAcc(ArrayList<TaiKhoan> acc) {
        try {
    ...
    public void searchAllRepect() throws ParseException {
        ...
        ArrayList<PhieuTao> result = null;
        ...
        Iterator<PhieuTao> itr = result.iterator();
        if (jDateChooserFrom.getDate() != null || jDateChooserTo.getDate() != null) {
            Date from;
            Date to;
            if (jDateChooserFrom.getDate() != null && jDateChooserTo.getDate() == null) {
                from = DinhDangNgay.getInstance().ChangeFrom(jDateChooserFrom.getDate());
                to = DinhDangNgay.getInstance().ChangeTo(new Date());
                while (itr.hasNext()) {
                    PhieuTao phieu = itr.next();
                    if (!checkDate(phieu.getThoiGianTao(), from, to)) {
                        itr.remove();
                    }
                }
                ...
                from = DinhDangNgay.getInstance().ChangeFrom(new SimpleDateFormat("dd/MM/yyyy").parse(sDate1));
                to = DinhDangNgay.getInstance().ChangeTo(jDateChooserTo.getDate());
                while (itr.hasNext()) {
                    PhieuTao phieu = itr.next();
                    if (!checkDate(phieu.getThoiGianTao(), from, to)) {
                        itr.remove();
        ...
        ArrayList<PhieuTao> result1 = new ArrayList<>();
    ...
    public void filterThongKeSanPham() throws ParseException {
        ArrayList<ThongKeSanPham> thongKe = new ArrayList<>();
        if (jDateChooserFromPr.getDate() != null || jDateChooserToPr.getDate() != null) {
            ...
            thongKe = ThongKeBaoCaoDAO.getInstance().getThongKe(from, to);

        } else {
            thongKe = ThongKeBaoCaoDAO.getInstance().getThongKe();
        }
    ...
    private void loadDataToTableThongKeProduct(ArrayList<ThongKeSanPham> thongKe) {
        try {
    ...
    private ArrayList<ThongKeSanPham> searchTenSanPhamThongKe(ArrayList<ThongKeSanPham> arr, String name) {
        ArrayList<ThongKeSanPham> result = new ArrayList<>();
        for (ThongKeSanPham i : arr) {

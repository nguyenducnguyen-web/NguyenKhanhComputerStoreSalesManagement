 ...
 */
public class CapNhatPhieuXuat extends javax.swing.JDialog {

    /**
     * Creates new form CapNhatPhieuXuat
     */
    ...
    public CapNhatPhieuXuat(javax.swing.JInternalFrame parent, javax.swing.JFrame owner, boolean modal) throws UnsupportedLookAndFeelException {
        super(owner, modal);
    ...
    private CapNhatPhieuXuat(JFrame jFrame, boolean b) {
        super(jFrame, b);
        initComponents();
        setLocationRelativeTo(null);
    }
    ...
    private void displayInfo() {
        ...
        txtNguoiTao.setText(TaiKhoanDAO.getInstance().selectById(phieuxuat.getNguoiTao()).getUser());
    }
    ...
    private void initComponents() {
        ...
        jPanel2.add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 380, -1, -1));
        ...
        jPanel2.add(txtMaPhieu, new org.netbeans.lib.awtextra.AbsoluteConstraints(210, 370, 390, 36));

        jLabel3.setFont(new java.awt.Font("SF Pro Display", 1, 15)); // NOI18N
        jLabel3.setForeground(new java.awt.Color(255, 255, 255));
        jLabel3.setText("Người tạo phiếu");
        jPanel2.add(jLabel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 450, -1, -1));

        txtNguoiTao.setEditable(false);
        txtNguoiTao.setFont(new java.awt.Font("SF Pro Display", 0, 15)); // NOI18N
        jPanel2.add(txtNguoiTao, new org.netbeans.lib.awtextra.AbsoluteConstraints(210, 440, 390, 36));
        ...
        jPanel2.add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 20, 580, 330));
        ...
        jPanel2.add(btnNhapHang, new org.netbeans.lib.awtextra.AbsoluteConstraints(450, 570, 130, 37));
            ...
            if (soluongselect == 0) {
                ...
                if (soluongselect < soluong) {
                    ...
                    if (mtl != null) {
                        ...
                        ChiTietPhieuNhapXuat ctp = new ChiTietPhieuNhapXuat(phieuxuat.getMaPhieu(), mt.getMaMay(), soluong, mt.getGia());
                        CTPhieu.add(ctp);
                    }
                    loadDataToTableNhapHang();
                    textTongTien.setText(formatter.format(tinhTongTien()) + "đ");
    ...
    public static void main(String args[]) throws UnsupportedLookAndFeelException {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                CapNhatPhieuXuat dialog = new CapNhatPhieuXuat(new javax.swing.JFrame(), true);

...
import Controller.MaHoaMatKhau;
...
public class TaiKhoanForm extends javax.swing.JInternalFrame {
    ...
    private void initComponents() {
        ...
        btnDeleteAccount.setBackground(new java.awt.Color(255, 255, 0));
        ...
        btnDeleteAccount.setMargin(new java.awt.Insets(12, 70, 12, 70));
        ...
        btnEditAccount.setBackground(new java.awt.Color(0, 255, 255));
        ...
        btnEditAccount.setMargin(new java.awt.Insets(12, 70, 12, 70));
        ...
        btnEditAccount1.setBackground(new java.awt.Color(255, 204, 0));
        ...
        btnEditAccount1.setMargin(new java.awt.Insets(12, 70, 12, 70));
        ...
        exportExcel.setBackground(new java.awt.Color(0, 255, 0));
        ...
        exportExcel.setMargin(new java.awt.Insets(12, 70, 12, 70));
        ...
        importExcel.setBackground(new java.awt.Color(255, 51, 51));
        importExcel.setForeground(new java.awt.Color(255, 51, 51));
        importExcel.setText("Nhập Excel");
        importExcel.setBorder(null);
        ...
        importExcel.setMargin(new java.awt.Insets(12, 70, 12, 70));
        ...
        jPanel2.add(jToolBar1, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 660, 1160, 90));

        jPanel3.setBackground(new java.awt.Color(255, 51, 51));
        jPanel3.setBorder(javax.swing.BorderFactory.createTitledBorder("Tìm kiếm"));
        jPanel3.setLayout(new org.netbeans.lib.awtextra.AbsoluteLayout());

        cbxLuachon.setBackground(new java.awt.Color(0, 255, 255));
        ...
        jPanel2.add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 120, 1160, 530));
    ...
    private void btnAddActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAddActionPerformed
        // TODO add your handling code here:
        ThemTaiKhoan a;
        a = new ThemTaiKhoan(this, (JFrame) javax.swing.SwingUtilities.getWindowAncestor(this), rootPaneCheckingEnabled);
        a.setVisible(true);
    ...
    private void btnEditAccountActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEditAccountActionPerformed
        ...
        if (tblAccount.getSelectedRow() == -1) {
            ...
            if (getAccountSelect().getRole().equals("Admin")) {
                ...
                CapNhatTaiKhoan u = new CapNhatTaiKhoan(this, (JFrame) javax.swing.SwingUtilities.getWindowAncestor(this), rootPaneCheckingEnabled);
                u.setVisible(true);
            }
        }
        ...
        if (tblAccount.getSelectedRow() == -1) {
            ...
            if (check == JOptionPane.YES_OPTION) {
                ...
                if (textct.equals("")) {
                    ...
                    accReset.setPassword(MaHoaMatKhau.hashpw(textct, MaHoaMatKhau.gensalt(12)));
                    try {

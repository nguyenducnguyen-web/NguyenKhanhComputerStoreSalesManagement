 ...
 */
public class KhoiPhucMatKhau extends javax.swing.JDialog {
    ...
    public KhoiPhucMatKhau(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if (email.equals("")) {
            ...
            if (isValid(email)) {
                if (checkEmail(email)) {
                    otpNumber = getOTP();
                    GuiEmail.GuiOTP(email, otpNumber);
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        TaiKhoanDAO.getInstance().updatePassword(txtEmail.getText(),MaHoaMatKhau.hashpw(password,MaHoaMatKhau.gensalt(12)));
    ...
    public static void main(String args[]) throws UnsupportedLookAndFeelException {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                KhoiPhucMatKhau dialog = new KhoiPhucMatKhau(new javax.swing.JFrame(), true);
    ...
    private boolean checkEmail(String email) {
        ArrayList<TaiKhoan> acc = TaiKhoanDAO.getInstance().selectAll();
        for (TaiKhoan i : acc) {
